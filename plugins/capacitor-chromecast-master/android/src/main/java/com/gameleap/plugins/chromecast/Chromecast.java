...
public class Chromecast extends Plugin {
  ...
  @PluginMethod
  public boolean Play(final PluginCall pluginCall) {
  ...
  @PluginMethod
  public boolean Pause(final PluginCall pluginCall) {
  ...
  @PluginMethod
  public boolean seek(final PluginCall pluginCall) {

    this.media = connection.getChromecastSession();
    this.media.mediaSeek(pluginCall.getInt("time"));
    return true;
  }
  ...
  @PluginMethod
  public boolean getCurrentTime(final PluginCall pluginCall) {

    this.media = connection.getChromecastSession();
    this.media.getCurrentTime(new Callbackable<Integer>() {
      @Override
      public void call(Integer obj) {
        try {
          JSONObject response = new JSONObject("{\"time\":\""+obj+"\"}");
          pluginCall.success(JSObject.fromJSONObject(response));
...
//                    JSONArray out = new JSONArray();
    ...
    public boolean requestSession(final PluginCall pluginCall) {
        connection.requestSession(new ChromecastConnection.RequestSessionCallback() {
            ...
            public void onError(int errorCode) {
              ...
              pluginCall.error(Integer.toString(errorCode));
            }
     ...
     */
    @PluginMethod
    public boolean mediaEditTracksInfo(final PluginCall pluginCall) {
      JSArray activeTrackIds = pluginCall.getArray("activeTrackIds");
      long[] trackIds = new long[activeTrackIds.length()];
        ...
        this.media.mediaEditTracksInfo(trackIds);
        return true;
    }
