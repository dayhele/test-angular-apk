...
/* ------------------------------------   MEDIA FNs   ------------------------------------------- */
  ...
  public void mediaPlay() {
    ...
    activity.runOnUiThread(new Runnable() {
      public void run() {
        long teste = client.getApproximateStreamPosition();
     ...
     */
    public void mediaSeek(final long seekPosition) {
        if (client == null || session == null) {
            return;
        }
        activity.runOnUiThread(new Runnable() {
   ...
   * Media API - Calls play on the current media.
   */
  public void getCurrentTime(final Chromecast.Callbackable<Integer> callback) {
    if (client == null || session == null) {
      return;
    }
  ...
  /**
     ...
     */
    public void mediaEditTracksInfo(final long[] activeTracksIds) {
        if (client == null || session == null) {
            return;
        }
        activity.runOnUiThread(new Runnable() {
